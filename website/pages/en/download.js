        ...
        <Container className="mainContainer documentContainer postContainer">
          <article className="post">
            ...
            <p>
              ...
              version <strong>4</strong>. Vorple version 3.2.8 is the last release compatible with Inform 7 release 6M62 (version 9.3).
            </p>

            <ul>
              <li>
                <a href={siteConfig.baseUrl + "releases/vorple-inform7-4.0.1.zip"}>
                  Version 4.0.1: Extensions and template for Inform 7 version 10.1.0
                </a>
              </li>
              <li>
            ...
            <p>
              All Vorple versions are equally compatible with Inform 6. Using the latest version (4.0.1) is recommended
            ...
            <ul>
              <li>
                <a href={siteConfig.baseUrl + "releases/vorple-inform6-4.0.1.zip"}>
                  Version 4.0.1: Inform 6 libraries
                </a>
              </li>
            </ul>
