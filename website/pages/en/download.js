      ...
      <div className="docMainWrapper wrapper">
        <Container className="mainContainer documentContainer postContainer">
          <article className="post">
            ...
            <p>
              Vorple version 3.2.8 packages (released April 25, 2022) can be downloaded from the links below:
            </p>

            <ul>
              <li>
                <a href={siteConfig.baseUrl + "releases/vorple-inform6-3.2.8.zip"}>
                  Inform 6 libraries
                </a>
              </li>
              <li>
